-- Largely taken from https://github.com/playframework/prune/blob/bfce5d7cc315eae9f634ff61a4373f77802583a6/src/main/resources/com/typesafe/play/prune/assets/wrk_upload.lua
...
local FileBody = read_file("lenna.jpg")
...
done_disabled = function(summary, latency, requests)
  io.write("JSON: {\n")
  io.write('"summary":{\n')
